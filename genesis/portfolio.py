...
class Portfolio:
    ...
    def to_state_dict(self):
        return {
            ...
            "action_series": self.action_series,
        }

    def load_state_dict(self, d):
        self.initial_amount = d["initial_amount"]
        self.lookback_window_size = d["lookback_window_size"]
        self.holding_shares = d["holding_shares"]
        self.day_count = d["day_count"]
        self.date_series = d["date_series"]
        self.price_series = d["price_series"]
        self.portfolio_series = d["portfolio_series"]
        self.action_series = d["action_series"]